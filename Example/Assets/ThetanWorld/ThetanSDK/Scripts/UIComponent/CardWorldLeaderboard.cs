...
{
    public class CardWorldLeaderboard : MonoBehaviour
    {
        [SerializeField] private Button _btnTooltipInfo;
        [SerializeField] private TextMeshProUGUI _txtEndIn;
        [SerializeField] private TextMeshProUGUI _txtSeasonTitle;
        ...
        public void SetData(GameLeaderboardInfo leaderboardInfo)
        {
            ...
            _txtSeasonTitle.SetText("Season {0}", leaderboardInfo.currentSeason);
