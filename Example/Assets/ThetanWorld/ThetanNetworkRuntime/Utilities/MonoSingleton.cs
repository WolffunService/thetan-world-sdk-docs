    ...
    where T : MonoSingleton<T>
{
    ...
    public static T Instance
    {
        get
        {
            //if (!_alive)
            //{
            //    CommonLog.LogWarning("Instance '" + typeof(T) + "' already destroyed on application quit." +
            ...
            lock (ThreadLock)
            {
                ...
                if (instance == null)
                {
                    ...
                    isInitialized = false;
                    isAutoCreate = true;
                    //CommonLog.LogWarning("An instance of " + typeof(T) + " is needed in the scene, so '" + singleton +
